...
- [x] Push `codex/eng-03-replay-shrinker`, open a PR to `main`, and wait for all checks.
- [x] Mark this plan complete, merge with a merge commit, and mark ENG-03 complete in the ignored commercialization plan.
